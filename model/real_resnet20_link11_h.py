...
class ResNet20Real(nn.Module):
    def __init__(self, num_classes=7):
        ...
        self.fc = nn.Linear(1000, num_classes)  # 1000→num_classes
    ...
    def forward(self, x, is_feat=False, preact=False, return_reconstruction=False):
        # Input x shape: (batch_size, 1024) complex tensor
        # Extract real and imaginary parts, reshape to (batch_size, 2, 32, 32)
        ...
        x10 = self.fc(x_intermediate)  # num_classes维
