"""
Complex-valued ResNet50 with Attention for Radar Dataset
Extracted from training file with TimeFreqAttention mechanism
Input: (batch_size, 500) complex tensor
Reshape: (batch_size, 1, 20, 25) - maintains complex values
...
class CombinedModel(nn.Module):
    ...
    def __init__(self, num_classes=7):
        ...
        print("Initializing Complex ResNet50 with Attention for Radar Dataset...")
    ...
    def forward(self, x, is_feat=False, preact=False, return_features=False):
        # Input: (batch_size, 500) complex tensor
        # Reshape to: (batch_size, 1, 20, 25)
        out = x.reshape(x.shape[0], 1, 20, 25)
...
if __name__ == '__main__':
    ...
    # Create dummy input
    dummy_input = torch.randn(4, 500, dtype=torch.complex64)
