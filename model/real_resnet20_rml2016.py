"""
Real-valued ResNet20 for RML2016 Dataset
Input: (batch_size, 600) complex tensor
Extract I/Q: (batch_size, 2, 20, 30)
...
class ResNet20Real(nn.Module):
    ...
    Extract I/Q and reshape to: (batch_size, 2, 20, 30)
    ...
    def __init__(self, num_classes=6):
        ...
        print("Initializing Real ResNet20 for RML2016 Dataset...")
...
if __name__ == '__main__':
    # Test the model
    model = ResNet20Real(num_classes=6)
