...
DATASET_CONFIG = {
    'link11': {
        'data_path': 'E:/BaiduNet_Download/dataGen/gen_link11/link11_merged_data.pkl',
        'num_classes': 7,
    ...
    'ratr': {
        'data_path': 'E:/BaiduNet_Download/dataGen/small_ratr_100000_repeated',
        'num_classes': 3,
...
示例:
  ...
  python run/prepare_docdata_splits.py --dataset_type radar --num_edges 5 --dirichlet_alpha 0.3
    ...
    parser.add_argument('--partition_method', type=str, default='dirichlet', 
                        choices=['dirichlet'], 
                        help='数据划分方法')
    parser.add_argument('--dirichlet_alpha', type=float, default=8, 
    ...
    parser.add_argument('--seed', type=int, default=42, 
                        help='随机种子')
    parser.add_argument('--output_dir', type=str, default='dataset/splits/ratr_2048', 
                        help='输出目录')
