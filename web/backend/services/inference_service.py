...
def start_inference(task_id: str, mode: str) -> Dict:
    return run_task_async(task_id, mode=mode, summary=True)
    ...
    chart_data = {
        ...
        "timing_pie": {
            "data": [
                ...
                {"name": "网络传输", "value": round(timing["total_transfer"], 4)},
            ]
        },
        "summary": {
